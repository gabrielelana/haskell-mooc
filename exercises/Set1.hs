...
distance x1 y1 x2 y2 = sqrt (square (distanceL x1 x2) + square (distanceL y1 y2))
  where distanceL a b = abs (a - b)
        square a = a * a
...
checkPassword password | password `elem` ["swordfish", "mellon"] = "You're in."
